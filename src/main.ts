import { Plugin, type WorkspaceSidedock, type WorkspaceWindow } from 'obsidian';
...
export default class EditorFullScreen extends Plugin {
  ...
  async loadSettings(): Promise<void> {
    this.settings = {
      ...DEFAULT_SETTINGS,
      ...((await this.loadData()) as Partial<EFSSettings> | null)
    };
  }
  ...
  activateMode(): void {
    ...
    const leftDock = this.app.workspace.leftSplit as WorkspaceSidedock;
    const rightDock = this.app.workspace.rightSplit as WorkspaceSidedock;
